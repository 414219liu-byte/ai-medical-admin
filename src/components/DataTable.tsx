...
interface Props { columns: Column[]; rows: RowData[]; actions: string[]; selected: string[]; onSelected:(v:string[])=>void; onAction:(a:string,r:RowData)=>void }

export default function DataTable({columns,rows,actions,selected,onSelected,onAction}:Props) {
