...
export default function FilterBar(p: Props) {
  return <div className="filter-card">
    <div className="filter-fields">
      ...
      <label><span>开始时间</span><input type="date" value={p.date} onChange={e=>p.onDate(e.target.value)}/></label>
      <label><span>结束时间</span><input type="date" value={p.endDate} onChange={e=>p.onEndDate(e.target.value)}/></label>
